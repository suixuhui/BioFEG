...
def main(params):
    ...
    if params["zeshel"]:
        ...
        train_tensor_data = TensorDataset(context_input, candidate_input, label_input, src_input)
    else:
        train_tensor_data = TensorDataset(context_input, candidate_input, label_input)
